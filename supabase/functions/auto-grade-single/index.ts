...
The AI MUST NOT hallucinate or infer missing words in the student's answer based on the marking scheme. You must only evaluate the exact literal words written by the student.
